...
int main(int argc, char *argv[]) {
	...
	try{
		...
		desc.add_options()
			...
			("initialjumpLimit", po::value<unsigned>()->default_value(2500), "initial max iterations without improvement before backjump")
			//("jumpLimitDecrease", po::value<unsigned>()->default_value(400), "decrease in jumpLimit each time jumps without improve")
			("decreaseDivisor", po::value<unsigned>()->default_value(7), "decrease in jumpLimit each time jumps without improve")
			...
			("timeLog", po::value<bool>()->default_value(true), "Show time of each new best solution found")
